...
module.exports = function (ln, iID, smID) {
    ...
    ins.taxTableEntry(ln.Tax).then(taxID => {
        ...
        let inserts = [ln.LineNumber._text, ln.ProductCode._text, ln.Quantity._text, ln.UnitOfMeasure._text, ln.UnitPrice._text, ln.TaxPointDate._text, ln.Description._text, ln.CreditAmount._text, taxID, ln.SettlementAmount._text, IECAmount, null, stockMovementID, invoiceID, orderRefOriginatingOn, orderRefOrderDate];
